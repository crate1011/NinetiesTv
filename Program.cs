...
namespace NinetiesTV
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Print("Eighties Genres", EghtiesGenre(shows));
            Print("All Genre", AllGenres(shows));
            Print("NumShowsFromRandomRange", NumShowsFromRandomRange(shows));
            Print("Binge Time", BingeTime(shows));
            Print("HighestYearIMDB", HighestYearIMDB(shows));
        }
        ...
        **************************************************************************************************/
        ...
        {
            return shows.OrderByDescending(s => $"{s.Name} - {s.ImdbRating}").ToList();
        }
        ...
        {
            return shows.OrderByDescending(s => $"{s.Name} - {s.ImdbRating}").Take(3).ToList();
        }
        ...
        {
            return shows.OrderBy(s => $"{s.Name} - {s.ImdbRating}").Skip(1).ToList();
        }
        ...
        **************************************************************************************************/
        ...
        public static List<string> EghtiesGenre(List<Show> shows)
        {
